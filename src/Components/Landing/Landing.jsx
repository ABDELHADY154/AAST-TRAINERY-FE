        ...
        <div className='container'>
          <div className='d-flex flex-row '>
            <div id='DescCont' className='d-flex flex-column text-wrap bg-none '>
              ...
              <div className='fs-6 ' id='DescProv'>
                ...
                aspernatur a cumque, non maxime sit nulla excepturi pariatur inventore
                illum placeat.
              </div>
              <div
                id='Num'
              ...
              >
                {this.state.loading === false ? (
                  ...
                  <>
                    ...
                    <div className='col-12 col-md-4 d-flex justify-content-center text-center flex-column align-items-center'>
                      <CountUp className='Numbers' start={0} end={this.state.students} />

                      <div className='NumTitle'>Students</div>
                    </div>
                    <div className='col-12 col-md-4 d-flex justify-content-center text-center flex-column align-items-center'>
                      <CountUp className='Numbers' start={0} end={this.state.applied} />
            ...
            <div id='Experienceimg' className='d-flex flex-column d-none d-md-flex ms-5 '>
          ...
          <div className='d-flex flex-row' id='CoachCont'>
            <div className='fs-6 ' id='DescProv'>
              ...
              similique eum repellat nesciunt beatae error quod, tenetur aspernatur a
              cumque, non maxime sit nulla excepturi pariatur inventore illum placeat.
              orem ipsum dolor sit amet consectetur, adipisicing elit. Reiciendis numquam
              similique eum repellat nesciunt beatae error quod, tenetur aspernatur a
              cumque, non maxime sit nulla excepturi pariatur inventore illum placeat.
            </div>
          </div>
          <div className='d-flex flex-row flex-wrap  ' id='CoachCont'>
            <div className=' mt-3 col-md-4 col-12'>
              <div className='card m-md-5'>
                <img className='cardImg img-responsive' src={img1} height='200' />
            ...
            <div className=' mt-3  col-md-4 col-12'>
              <div className=' card m-md-5'>
                <img className='cardImg img-responsive' src={img3} height='200' />
                <div className='carousel-caption2'>
            ...
            <div className=' mt-3 col-md-4 col-12'>
              <div className=' card m-md-5'>
                <img className='cardImg img-responsive' src={img2} height='200' />
                <div className='carousel-caption2'>
