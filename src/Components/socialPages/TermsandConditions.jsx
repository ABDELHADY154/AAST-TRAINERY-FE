    ...
    return (
      <div>
        <div className="container mb-5 mt-5">
          ...
          <h1>General Terms</h1>
          <p>
            By accessing and placing an order with Trainery, you confirm that
            ...
            communication between you and Trainery.
          </p>
          <p>
            Under no circumstances shall Trainery team be liable for any direct,
            ...
            Trainery team or an authorized representative has been advised of
          ...
          <p>
            Trainery will not be responsible for any outcome that may occur
          ...
          <h1>License</h1>
          <p>
            Trainery grants you a revocable, non-exclusive, non-transferable,
            limited license to download, install and use the website/app
            strictly in accordance with the terms of this Agreement.
          </p>
          <p>
            These Terms & Conditions are a contract between you and Trainery
            (referred to in these Terms & Conditions as "Trainery", "us", "we"
            or "our"), the provider of the Trainery website and the services
            accessible from the Trainery website (which are collectively
            referred to in these Terms & Conditions as the "Trainery Service").
          </p>
          <p>
            ...
            Trainery Service. In these Terms & Conditions, "you" refers both to
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to Trainery, that is responsible for your
              information under this Terms & Conditions.
            </li>
            <li>
              Country: where Trainery or the owners/founders of Trainery are
              based, in this case is EG
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit Trainery
              and use the services.
            </li>
            <li>
              Service: refers to the service provided by Trainery as described
            ...
            <li>
              Website: Trainery's site, which can be accessed via this URL:
              <Link to="/" style={{ color: "#1e4274" }}>
                aast-trainery.com
              </Link>
            </li>
            <li>
              You: a person or entity that is registered with Trainery to use
              the Services.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              notice of copyright or trademark) of Trainery or its affiliates,
              partners, suppliers or the licensors of the website/app.
            </li>
          </ul>
          <h1>Return and Refund Policy</h1>
          <p>
            Thanks for shopping at Trainery. We appreciate the fact that you
          ...
          <p>
            ...
            apply to transactions at Trainery. We’ll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at Trainery, you agree to the terms
            along with Trainery's Privacy Policy.
          </p>
          <p>
          ...
          <p>
            ...
            (collectively, "Suggestions") provided by you to Trainery with
            respect to the website/app shall remain the sole and exclusive
            property of Trainery.
          </p>
          <p>
            Trainery shall be free to use, copy, modify, publish, or
          ...
          <p>
            ...
            Trainery. We are not responsible for the content, accuracy or
          ...
          <h1>Cookies</h1>
          <p>
            Trainery uses "Cookies" to identify the areas of our website that
          ...
          <p>
            You acknowledge and agree that Trainery may stop (permanently or
            temporarily) providing the Service (or any features within the
            Service) to you or to users generally at Trainery’s sole discretion,
            without prior notice to you. You may stop using the Service at any
            time. You do not need to specifically inform Trainery when you stop
            using the Service. You acknowledge and agree that if Trainery
          ...
          <p>
            Trainery reserves the right to modify, suspend or discontinue,
          ...
          <p>
            Trainery may from time to time provide enhancements or improvements
          ...
          <p>
            ...
            of the website/app. You agree that Trainery has no obligation to (i)
          ...
          <p>
            You acknowledge and agree that Trainery shall not be responsible for
            any Third-Party Services, including their accuracy, completeness,
            timeliness, validity, copyright compliance, legality, decency,
            quality or any other aspect thereof. Trainery does not assume and
          ...
          <p>
            Trainery may, in its sole discretion, at any time and for any or no
          ...
          <p>
            ...
            Trainery, in the event that you fail to comply with any provision of
          ...
          <p>
            Termination of this Agreement will not limit any of Trainery's
          ...
          <p>
            You agree to indemnify and hold Trainery and its parents,
            ...
            of the website/app; (b) violation of this Agreement or any law or
          ...
          <p>
            ...
            maximum extent permitted under applicable law, Trainery, on its own
            ...
            the website/app, including all implied warranties of
            merchantability, fitness for a particular purpose, title and
            non-infringement, and warranties that may arise out of course of
            dealing, course of performance, usage or trade practice. Without
            limitation to the foregoing, Trainery provides no warranty or
          ...
          <p>
            Without limiting the foregoing, neither Trainery nor any Trainery's
            ...
            or on behalf of Trainery are free of viruses, scripts, trojan
          ...
          <p>
            ...
            liability of Trainery and any of its suppliers under any provision
          ...
          <p>
            ...
            Trainery or its suppliers be liable for any special, incidental,
            ...
            connection with any provision of this Agreement), even if Trainery
          ...
          <p>
            ...
            notices published by Trainery on the Services, shall constitute the
            entire agreement between you and Trainery concerning the Services.
            ...
            such term or any other term, and Trainery's failure to assert any
            right or provision under this Agreement shall not constitute a
            waiver of such right or provision. YOU AND Trainery AGREE THAT ANY
          ...
          <p>
            Trainery reserves the right, at its sole discretion, to modify or
          ...
          <p>
            ...
            Trainery regarding your use of the website/app and supersedes all
          ...
          <p>
            ...
            when you use or purchase other Trainery's services, which Trainery
          ...
          <p>
            ...
            arrangement thereof), are owned by Trainery, its licensors or other
            providers of such material and are protected by EG and international
            ...
            Trainery, unless and except as is expressly provided in these Terms
          ...
          <p>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Trainery's
            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
            action, or other controversy between you and Trainery concerning the
          ...
          <p>
            In the event of a dispute, you or Trainery must give the other a
            ...
            <a
              ...
              // class="__cf_email__"
              // data-cfemail="fe9f9a939790be9f9f8d8ad38a8c9f97909b8c87d09d9193"
            >
              admin@aast-trainery.com{" "}
            </a>
            Trainery will send any Notice of Dispute to you by mail to your
            address if we have it, or otherwise to your email address. You and
            Trainery will attempt to resolve any dispute through informal
            negotiation within sixty (60) days from the date the Notice of
            Dispute is sent. After sixty (60) days, you or Trainery may commence
            arbitration.
          </p>

          <h1>Binding Arbitration</h1>
          <p>
            If you and Trainery don’t resolve any dispute by informal
          ...
          <p>
            ...
            property of Trainery without any compensation or credit to you
            whatsoever. Trainery and its affiliates shall have no obligations
          ...
          <h1>Promotions</h1>
          <p>
            Trainery may, from time to time, include contests, promotions,
          ...
          <p>
            ...
            signed by an authorized representative of Trainery. Trainery will be
            ...
            breach or anticipatory breach by you. Trainery operates and controls
            the Trainery Service from its offices in EG. The Service is not
            ...
            to access the Trainery Service from other locations do so on their
            ...
            Conditions (which include and incorporate the Trainery Privacy
            Policy) contains the entire understanding, and supersedes all prior
            understandings, between you and Trainery concerning its subject
          ...
          <h1>Disclaimer</h1>
          <p>
            Trainery is not responsible for any content, code or any other
            imprecision.
          </p>
          <p>Trainery does not provide warranties or guarantees.</p>
          <p>
            In no event shall Trainery be liable for any special, direct,
          ...
          <p>
            The Trainery Service and its contents are provided "as is" and "as
            available" without any warranty or representations of any kind,
            whether express or implied. Trainery is a distributor and not a
            publisher of the content supplied by third parties; as such,
            Trainery exercises no editorial control over such content and makes
            ...
            provided through or accessible via the Trainery Service. Without
            limiting the foregoing, Trainery specifically disclaims all
            warranties and representations in any content transmitted on or in
            connection with the Trainery Service or on sites that may appear as
            links on the Trainery Service, or in the products provided as a part
            of, or otherwise in connection with, the Trainery Service, including
            without limitation any warranties of merchantability, fitness for a
            particular purpose or non-infringement of third party rights. No
            oral advice or written information given by Trainery or any of its
            ...
            change without notice. Without limiting the foregoing, Trainery does
            not warrant that the Trainery Service will be uninterrupted,
          ...
          <ul>
            ...
            <li>
              Via this Link:
              <Link to="/contactus">
                http://aast-trainery.com/contactUs
              </Link>{" "}
            </li>
          </ul>
        </div>
