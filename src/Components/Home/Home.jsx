...
import { BsCheck, BsArrowUpRight, BsBookmark, BsFillBookmarkFill } from "react-icons/bs";
        ...
        this.state.alert == true ? (
          <div id='alerting' className='d-flex flex-row  flex-wrap py-2  mb-3 '>
            <div className='container d-flex flex-row  flex-wrap '>
              <div id='alertingtitle' className='d-flex flex-column col-md-10 col-9 mt-1'>
              ...
              this.state.explorePosts.length !== 1 ? (
                <>
                  <BigCard
                    ...
                    application_deadline={this.state.explorePosts[0].application_deadline}
                  ...
                  <BigCard
                    ...
                    application_deadline={this.state.explorePosts[1].application_deadline}
        ...
        <div className='card'>
          <div className='card-body'>
            ...
            <div id='job' className=' d-flex flex-row ms-5 flex-wrap  '>
              <Link to={`/CompanyProfile/${this.props.company_id}`}>
                <div className='d-flex ms-3 flex-row'>{this.props.company_name}</div>
              </Link>

              <div id='gold' className=' ms-2 departments d-flex flex-row flex-wrap '>
  ...
  return (
    <div className='card'>
      <div className='card-body'>
        ...
        <div className='d-flex flex-row flex-wrap '>
          <div className='d-flex flex-column  col-4 col-md-1 me-4 ' id='firsttagipad'>
